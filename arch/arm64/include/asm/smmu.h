...
#define STRTAB_BASE_CFG_LOG2SIZE(x) ((x) & 0x3f) /* log2 of linear table entries */
...
#define STE2_S2_ENCODE(vmid)                        \
        (((uint64_t)(vmid) << STE_2_S2VMID_SHIFT) | \
         (25UL << STE_2_S2T0SZ_SHIFT) |             \
         (1UL << STE_2_S2SL0_SHIFT) |               \
         (1UL << STE_2_S2IR0_SHIFT) |               \
         (1UL << STE_2_S2OR0_SHIFT) |               \
         STE_2_S2SH0_IS |                           \
         STE_2_S2TG_4K |                            \
         STE_2_S2PS_40BIT |                         \
         STE_2_S2AA64 |                             \
...
{
        while ((smmu_read32(base, SMMU_CR0ACK) & CR0_TRANSLATIONEN) != (cr0_val & CR0_TRANSLATIONEN))
