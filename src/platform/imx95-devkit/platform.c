...
static void imx95_uart_putchar(char c) { uart_putchar(IMX95_UART1_BASE, c); }

/* -----------------------------------------------------------------------
 * GICv3 base addresses (i.MX95)
 * ----------------------------------------------------------------------- */

static uint64_t imx95_gic_dist_base(void) { return IMX95_GIC_DIST_BASE; }
static uint64_t imx95_gic_redist_base(void) { return IMX95_GIC_REDIST_BASE; }

/* -----------------------------------------------------------------------
 * SMMUv3 base address (i.MX95)
 * ----------------------------------------------------------------------- */

static uint64_t imx95_smmu_base(void) { return IMX95_SMMU_BASE; }
...
static uint64_t imx95_timer_freq(void) { return IMX95_TIMER_FREQ; }

/* i.MX95: 6 Cortex-A55 cores (0–5); Cortex-M7 runs separately */
static uint32_t imx95_nr_cpus(void) { return IMX95_NR_CPUS; }
