...
int main(void) {
   ...
   */
  results[idx++] = run_case("stage2_contains_hot_path", BENCH_PARTITION_ID,
   ...
   */
  results[idx++] = run_case("stage2_contains_cold_path", BENCH_PARTITION_ID,
   ...
   */
  results[idx++] = run_case("stage2_contains_low_boundary", BENCH_PARTITION_ID,
   ...
   */
  results[idx++] = run_case("stage2_contains_high_boundary", BENCH_PARTITION_ID,
