...
static void scenario_s1_unassigned_streamid_denied(void)
{
        ...
        rc = hv_smmu_check_dma_access(phantom_sid, 0x80000000ULL,
                                      0x1000U, HV_DMA_RW);
        FAIL_IF(rc != HV_EPERM,
...
static void scenario_s2_dma_outside_window_denied(void)
{
        ...
        rc = hv_smmu_configure_dma_window(sid,
                                          DMA_WINDOW_BASE,
                                          DMA_WINDOW_SIZE,
                                          DMA_WINDOW_BASE,
                                          HV_DMA_RW);
        ...
        rc = hv_smmu_check_dma_access(sid,
                                      DMA_WINDOW_BASE + DMA_WINDOW_SIZE + 0x10000U,
                                      0x1000U, HV_DMA_RW);
        FAIL_IF(rc != HV_EPERM,
...
static void scenario_s3_cross_partition_overlap_denied(void)
{
        ...
        rc = hv_smmu_configure_dma_window(sid_a,
                                          DMA_WINDOW_BASE,
                                          DMA_WINDOW_SIZE,
                                          DMA_WINDOW_BASE,
                                          HV_DMA_RW);
...
static void scenario_s4_reset_partition_revokes_all(void)
{
        ...
        rc = hv_smmu_configure_dma_window(sid1,
                                          DMA_WINDOW_BASE,
                                          DMA_WINDOW_SIZE,
                                          DMA_WINDOW_BASE,
                                          HV_DMA_RO);
        ...
        rc = hv_smmu_configure_dma_window(sid2,
                                          DMA_WINDOW_BASE + DMA_WINDOW_SIZE,
                                          DMA_WINDOW_SIZE,
                                          DMA_WINDOW_BASE + DMA_WINDOW_SIZE,
                                          HV_DMA_RO);
        ...
        rc = hv_smmu_check_dma_access(sid1,
                                      DMA_WINDOW_BASE, 0x1000U, HV_DMA_RO);
        FAIL_IF(rc != HV_OK, "S4: sid1 should be accessible before reset");

        rc = hv_smmu_check_dma_access(sid2,
                                      DMA_WINDOW_BASE + DMA_WINDOW_SIZE,
                                      0x1000U, HV_DMA_RO);
...
static void scenario_s5_revocation_and_reuse(void)
{
        ...
        rc = hv_smmu_check_dma_access(sid,
                                      DMA_WINDOW_BASE, 0x1000U, HV_DMA_WO);
        FAIL_IF(rc != HV_EPERM,
        ...
        FAIL_IF(rc != HV_OK,
                "S5: reallocation to partition B should succeed");

        rc = hv_smmu_configure_dma_window(new_sid,
                                          PA_B_BASE,
                                          DMA_WINDOW_SIZE,
                                          PA_B_BASE,
                                          HV_DMA_RW);
        ...
        rc = hv_smmu_check_dma_access(new_sid,
                                      PA_B_BASE, 0x1000U, HV_DMA_RW);
        FAIL_IF(rc != HV_OK,
