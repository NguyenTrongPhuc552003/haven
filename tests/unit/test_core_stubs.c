...
static void test_stage2_contract(void) {
  ...
  struct hv_mem_region misaligned_ipa_region[1] = {
      {.ipa_base = 0x1800, .pa_base = 0x3000, .size = 0x1000, .attrs = 0}};
  struct hv_mem_region misaligned_pa_region[1] = {
      {.ipa_base = 0x2000, .pa_base = 0x2800, .size = 0x1000, .attrs = 0}};
  struct hv_mem_region misaligned_size_region[1] = {
      {.ipa_base = 0x3000, .pa_base = 0x4000, .size = 0x1800, .attrs = 0}};
  struct hv_mem_region second_partition_regions[1] = {
      {.ipa_base = 0x1000, .pa_base = 0x2000, .size = 0x1000, .attrs = 0}};
  struct hv_mem_region non_overlapping_partition_regions[1] = {
      {.ipa_base = 0x4000, .pa_base = 0x5000, .size = 0x1000, .attrs = 0}};
  ...
  assert(hv_stage2_map_partition(&second_partition_overlap_cfg) == HV_EPERM);
