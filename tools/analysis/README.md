...
JSON output produced by Haven's benchmark suite (`cmake --preset host-tests && cmake --build build-host && ctest --test-dir build-host` writes results
to `build/benchmarks/`).
